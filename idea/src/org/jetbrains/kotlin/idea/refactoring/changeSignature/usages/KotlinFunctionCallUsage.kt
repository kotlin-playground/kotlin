...
class KotlinFunctionCallUsage(
    ...
    private fun updateArgumentsAndReceiver(changeInfo: KotlinChangeInfo, element: KtCallElement, allUsages: Array<out UsageInfo>) {
        ...
        if (!hasLambdaArgumentsBefore && shouldMoveLambdaOut) {
