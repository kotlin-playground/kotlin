...
internal val unaryOperations: HashMap<UnaryOperationKey<*>, Pair<Function1<Any?, Any>, Function1<Long, Long>>>
    ...
    unaryOperation(BYTE, "unaryPlus", { a -> a.minus() }, emptyUnaryFun),
    ...
    unaryOperation(DOUBLE, "unaryPlus", { a -> a.minus() }, emptyUnaryFun),
    ...
    unaryOperation(FLOAT, "unaryPlus", { a -> a.minus() }, emptyUnaryFun),
    ...
    unaryOperation(INT, "unaryPlus", { a -> a.minus() }, emptyUnaryFun),
    ...
    unaryOperation(LONG, "unaryPlus", { a -> a.minus() }, emptyUnaryFun),
    ...
    unaryOperation(SHORT, "unaryPlus", { a -> a.minus() }, emptyUnaryFun),
