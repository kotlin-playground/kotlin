...
public class TypeResolver(
    ...
    private fun collectArgumentsForClassTypeConstructor(
        ...
        for (index in 0..classChainLastIndex) {
            ...
            val currentParameters = if (wasStatic) emptyList() else classDescriptorChain[index].declaredTypeParameters
            ...
            else if (wasStatic && !currentArguments.isEmpty()) {
        ...
        val nonClassQualifierParts =
                reversedQualifierParts.subList(
                        Math.min(classChainLastIndex + 1, reversedQualifierParts.lastIndex),
                        reversedQualifierParts.lastIndex)
